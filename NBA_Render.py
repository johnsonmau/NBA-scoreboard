...
class Render:
    def __init__(self):
        ...
        self.path = '/home/mj/NBA-scoreboard/'
        
        self.font = graphics.Font()
        self.font.LoadFont("/home/mj/rpi-rgb-led-matrix/fonts/6x12.bdf")
        self.font2 = graphics.Font()
        self.font2.LoadFont("/home/mj/rpi-rgb-led-matrix/fonts/4x6.bdf")
    ...
    def Render_Games(self, printer=False):
        ...
        for game in game_data:
            ...
            graphics.DrawText(canvas, self.font2, 2, 18, graphics.Color(255, 255, 0), "JR")
